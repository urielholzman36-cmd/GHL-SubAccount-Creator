  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 w-10 h-10 flex flex-col items-center justify-center gap-1.5 rounded-lg bg-white/5 backdrop-blur-md border border-white/10 hover:bg-white/10 transition-colors"
      >
        <span className={`block w-5 h-0.5 bg-white/70 transition-all duration-300 ${open ? 'translate-y-2 rotate-45' : ''}`} />
