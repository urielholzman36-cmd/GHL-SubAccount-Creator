...
export function buildUserMessage(build) {
  ...
  return [
    ...
    `3. What the business does: ${build.business_description || 'Not specified'}`,
    `4. Location / service area: ${location}`,
    `5. Target audience: ${build.target_audience || 'Not specified'}`,
    `6. Primary goal of the website: Lead generation`,
    `7. Logo: Yes (provided by client, see brand colors)`,
    `8. Preferred color palette: ${colors}`,
    `9. Desired design style: Your choice — pick the most appropriate style for this industry and audience`,
    `10. Existing website or content: ${existingSite}`,
    `11. Should the website be WordPress-based or a regular website: WordPress, built with Elementor`,
    '',
